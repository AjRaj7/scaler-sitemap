...
// Source 1 — Framer guide pages (rewritten from the Framer domain).
...
// Source 2 — the College Predictor app's own sitemap. Already served under
// www.scaler.com (reverse-proxied subpath), so no domain rewrite is needed.
// Pulling it here means the hourly Action keeps the predictor's hub, per-exam,
// cutoff and college pages in the brand-domain sitemap automatically.
